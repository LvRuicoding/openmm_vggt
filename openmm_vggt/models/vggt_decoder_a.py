...
class VGGT_decoder_a(nn.Module, PyTorchModelHubMixin):
    ...
    def forward(self, images: torch.Tensor, query_points: torch.Tensor = None,others = None):
        ...
        # real_world_extrinics = torch.ones_like(real_world_extrinics)
        real_world_extrinics_enc = extri_to_pose_encoding(real_world_extrinics) # B S 7(4+3)
        real_world_extrinics_enc = torch.randn_like(real_world_extrinics_enc)
