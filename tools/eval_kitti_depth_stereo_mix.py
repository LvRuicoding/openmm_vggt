...
Usage:
  python tools/eval_kitti_depth_stereo_mix.py \
      configs/kitti_depth_stereo_mix_ft.py \
      --checkpoint trainoutput/kitti_depth_stereo_mix_ft/epoch_002.pth

  torchrun --nproc_per_node=4 tools/eval_kitti_depth_stereo_mix.py \
      configs/kitti_depth_stereo_mix_ft.py \
      --checkpoint trainoutput/kitti_depth_stereo_mix_ft/epoch_002.pth
"""
...
DEFAULT_CONFIG_PATH = REPO_ROOT / "configs" / "kitti_depth_stereo_mix_ft.py"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate mix_decoder_global_early on KITTI depth completion val split."
    )
    parser.add_argument(
        "config",
        nargs="?",
