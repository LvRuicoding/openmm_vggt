...
# Variant model: mix_decoder_global_serializer2d_early
# Applies projected 2D serialization and a standard self-attention residual block
# immediately after patch embedding, before the VGGT backbone attention stack.
...
model = dict(
    type='mix_decoder_global_serializer2d_early',
    img_size=518,
    patch_size=14,
    embed_dim=1024,
    enable_camera=True,
...
output_dir = '/home/dataset-local/lr/code/openmm_vggt/trainoutput/kitti_depth_stereo_serializer2d_early_ft'
