...
# Variant model: mix_decoder_global_window_attn_early_late
# Applies regular + shifted-window patch/voxel attention after patch embedding
# and again on the final aggregator layer before four-layer selection.
...
model = dict(
    type='mix_decoder_global_window_attn_early_late',
    img_size=518,
    patch_size=14,
    embed_dim=1024,
    enable_camera=True,
...
output_dir = '/home/dataset-local/lr/code/openmm_vggt/trainoutput/kitti_depth_stereo_mix_window_attn_early_late_ft'
