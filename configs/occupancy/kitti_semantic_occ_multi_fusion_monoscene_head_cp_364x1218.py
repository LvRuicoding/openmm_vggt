# mmengine-style config for KITTI semantic voxel occupancy multi-fusion fine-tuning
...
model = dict(
    type="mix_decoder_global_multi_fusion_occ",
    img_size=518,
    patch_size=14,
    embed_dim=1024,
    enable_camera=False,
...
output_dir = "/home/dataset-local/lr/code/openmm_vggt/trainoutput/kitti_semantic_occ_multi_fusion_monoscene_head_cp_364x1218"
